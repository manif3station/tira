...
close $env;
like( $env_text, qr/^VERSION=0\.68$/m, '.env stores version 0.68' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '0.68', 'module version matches .env' );
...
is( scalar @commands, 94, 'release ships exactly 94 executable CLI entrypoints' );
