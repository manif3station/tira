...
close $env;
like( $env_text, qr/^VERSION=1\.20$/m, '.env stores version 1.20' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '1.20', 'module version matches .env' );
...
is( scalar @commands, 126, 'release ships exactly 126 executable CLI entrypoints' );
