...
close $env;
like( $env_text, qr/^VERSION=2\.45$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '2.45', 'and the release being made is the one intended' );
...
is( scalar @commands, 149, 'release ships exactly 149 executable CLI entrypoints' );
