...
close $env;
like( $env_text, qr/^VERSION=0\.65$/m, '.env stores version 0.65' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '0.65', 'module version matches .env' );
...
is( scalar @commands, 88, 'release ships exactly 88 executable CLI entrypoints' );
