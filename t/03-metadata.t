...
close $env;
like( $env_text, qr/^VERSION=4\.91$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '4.91', 'and the release being made is the one intended' );
...
is( scalar @commands, 179, 'release ships exactly 179 executable CLI entrypoints' );
