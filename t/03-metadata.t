...
close $env;
like( $env_text, qr/^VERSION=5\.33$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '5.33', 'and the release being made is the one intended' );
...
is( scalar @commands, 186, 'release ships exactly 186 executable CLI entrypoints' );
