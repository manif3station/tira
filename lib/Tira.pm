...
.card-list__row{display:flex;align-items:center;gap:.5rem}.card-list__check{margin-left:auto;width:1.1rem;height:1.1rem;flex-shrink:0;cursor:pointer}.card-list__text{margin-right:auto}.card-list__action{padding:.1rem .4rem;color:#67e8f9;background:transparent;border:1px solid rgba(103,232,249,.25);border-radius:.5rem;font-size:.78rem;cursor:pointer;opacity:.65}.card-list__action:hover{opacity:1}.card-list__action--danger:hover{color:#fecaca;border-color:rgba(248,113,113,.5);background:rgba(153,27,27,.3)}
