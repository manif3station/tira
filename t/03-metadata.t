...
close $env;
like( $env_text, qr/^VERSION=5\.42$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '5.42', 'and the release being made is the one intended' );
...
is( scalar @commands, 188, 'release ships exactly 188 executable CLI entrypoints' );
