...
close $env;
like( $env_text, qr/^VERSION=3\.91$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '3.91', 'and the release being made is the one intended' );
...
is( scalar @commands, 172, 'release ships exactly 172 executable CLI entrypoints' );
