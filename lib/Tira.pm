...
sub _dashboard_table {
    ...
    $boards .= '<section class="board board--tasklist" data-type="tasklist">'
      ...
      . '<input class="tasklist-session" type="text" placeholder="Session (blank = shared)" aria-label="Session"></header>'
      ...
      . '<button type="button" class="tasklist-unshift">Unshift</button>'
      . '<button type="button" class="tasklist-slice">Insert at position</button>'
      . '<button type="button" class="tasklist-next">Next</button>'
      . '<button type="button" class="tasklist-shift">Shift</button>'
      . '<button type="button" class="tasklist-pop">Pop</button>'
      . '<button type="button" class="tasklist-prune">Prune done</button>'
      . '<button type="button" class="tasklist-import">Import from card</button>'
      . '</div><p class="tasklist-error" hidden></p><p class="tasklist-notice" hidden></p><ol class="tasklist-cards"></ol></section>'
      if $args{live};
...
.tasklist-error{color:#fca5a5;margin:0 .45rem .6rem}.tasklist-notice{color:var(--ink,#e2e8f0);background:rgba(103,232,249,.12);border:1px solid rgba(103,232,249,.3);border-radius:.5rem;padding:.4rem .6rem;margin:0 .45rem .6rem}.tasklist-inline-capture{display:inline-flex;gap:.3rem;margin-left:.4rem}
.tasklist-error[hidden]{display:none}
