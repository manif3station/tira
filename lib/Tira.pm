...
sub _dashboard_table {
    ...
    my $dialog = $args{live}
      ? '<dialog class="card-dialog"><header><div><span class="card-dialog__ref">Card</span><h2 class="card-dialog__title">Details</h2></div><button class="card-dialog__close" type="button" aria-label="Close">&times;</button></header><p class="card-dialog__error" hidden></p><div class="card-dialog__sections"></div></dialog>'
      : '';
