...
close $env;
like( $env_text, qr/^VERSION=2\.14$/m, '.env stores version 2.08' );
...
is( $Tira::VERSION, '2.14', 'and the release being made is the one intended' );
...
is( scalar @commands, 146, 'release ships exactly 146 executable CLI entrypoints' );
