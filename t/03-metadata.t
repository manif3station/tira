...
close $env;
like( $env_text, qr/^VERSION=0\.04$/m, '.env stores version 0.04' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '0.04', 'module version matches .env' );
...
is( scalar @commands, 72, 'release ships exactly 72 executable CLI entrypoints' );
