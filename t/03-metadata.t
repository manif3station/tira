...
close $env;
like( $env_text, qr/^VERSION=4\.11$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '4.11', 'and the release being made is the one intended' );
...
is( scalar @commands, 177, 'release ships exactly 177 executable CLI entrypoints' );
