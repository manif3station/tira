...
close $env;
like( $env_text, qr/^VERSION=3\.90$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '3.90', 'and the release being made is the one intended' );
...
is( scalar @commands, 165, 'release ships exactly 165 executable CLI entrypoints' );
