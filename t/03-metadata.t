...
close $env;
like( $env_text, qr/^VERSION=2\.33$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '2.33', 'and the release being made is the one intended' );
...
is( scalar @commands, 148, 'release ships exactly 148 executable CLI entrypoints' );
