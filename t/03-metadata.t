...
close $env;
like( $env_text, qr/^VERSION=0\.66$/m, '.env stores version 0.66' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '0.66', 'module version matches .env' );
...
is( scalar @commands, 89, 'release ships exactly 89 executable CLI entrypoints' );
