...
close $env;
like( $env_text, qr/^VERSION=0\.79$/m, '.env stores version 0.79' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '0.79', 'module version matches .env' );
...
is( scalar @commands, 100, 'release ships exactly 100 executable CLI entrypoints' );
