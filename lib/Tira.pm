...
sub _dashboard_table {
    ...
    for my $type (qw(sow epic ticket)) {
        ...
        $boards .= '<section class="board board--' . $type . '" data-type="' . $type . '">'
          ...
          . '<button type="button" class="board-review" data-review="' . $type
          . '" aria-pressed="false" title="Show only cards whose answers are waiting for you to accept or reject">'
