...
close $env;
like( $env_text, qr/^VERSION=1\.21$/m, '.env stores version 1.21' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '1.21', 'module version matches .env' );
...
is( scalar @commands, 127, 'release ships exactly 127 executable CLI entrypoints' );
