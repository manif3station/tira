...
close $env;
like( $env_text, qr/^VERSION=5\.32$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '5.32', 'and the release being made is the one intended' );
...
is( scalar @commands, 185, 'release ships exactly 185 executable CLI entrypoints' );
