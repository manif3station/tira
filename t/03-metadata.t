...
close $env;
like( $env_text, qr/^VERSION=0\.60$/m, '.env stores version 0.60' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '0.60', 'module version matches .env' );
...
is( scalar @commands, 87, 'release ships exactly 87 executable CLI entrypoints' );
