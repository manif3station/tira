...
# The TKT-583 repeated-proof-pair sequence (one pair cannot answer two
# instructions in the same column, the --force escape and its reason, and
# the move-time reminder) is its own concern, split out into
# t/1047-a-pair-asked-to-answer-twice.t - TKT-1047.
