...
# The per-item attachment/ref subverb block (--attach on add,
# tasklist.task.attach.add/discard, tasklist.task.ref.link/unlink) is its
# own concern, split out into t/1046-a-file-that-followed-an-item.t -
# TKT-1046.
