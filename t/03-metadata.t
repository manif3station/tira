...
close $env;
like( $env_text, qr/^VERSION=0\.09$/m, '.env stores version 0.09' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '0.09', 'module version matches .env' );
...
is( scalar @commands, 80, 'release ships exactly 80 executable CLI entrypoints' );
