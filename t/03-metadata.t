...
close $env;
like( $env_text, qr/^VERSION=5\.17$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '5.17', 'and the release being made is the one intended' );
...
is( scalar @commands, 180, 'release ships exactly 180 executable CLI entrypoints' );
