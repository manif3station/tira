...
close $env;
like( $env_text, qr/^VERSION=2\.89$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '2.89', 'and the release being made is the one intended' );
...
is( scalar @commands, 151, 'release ships exactly 151 executable CLI entrypoints' );
