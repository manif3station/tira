...
close $env;
like( $env_text, qr/^VERSION=3\.09$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '3.09', 'and the release being made is the one intended' );
...
is( scalar @commands, 154, 'release ships exactly 154 executable CLI entrypoints' );
