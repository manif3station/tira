...
sub _card_to_review {
    ...
    for my $question ( @{ $record->{questions} // [] } ) {
        ...
        return 1 if !defined $answer->{mark};
    }
    return 0;
}
...
sub _card_waiting {
    ...
    for my $question ( @{ $record->{questions} // [] } ) {
        ...
        return 1 if !$answer;
        return 1 if !defined $answer->{read_at} || !defined $answer->{mark};
    }
    return 0;
}
