...
close $env;
like( $env_text, qr/^VERSION=5\.63$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '5.63', 'and the release being made is the one intended' );
...
is( scalar @commands, 190, 'release ships exactly 190 executable CLI entrypoints' );
