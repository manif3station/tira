...
close $env;
like( $env_text, qr/^VERSION=3\.57$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '3.57', 'and the release being made is the one intended' );
...
is( scalar @commands, 156, 'release ships exactly 156 executable CLI entrypoints' );
