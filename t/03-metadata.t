...
close $env;
like( $env_text, qr/^VERSION=0\.47$/m, '.env stores version 0.47' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '0.47', 'module version matches .env' );
...
is( scalar @commands, 84, 'release ships exactly 84 executable CLI entrypoints' );
