...
close $env;
like( $env_text, qr/^VERSION=3\.54$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '3.54', 'and the release being made is the one intended' );
...
is( scalar @commands, 155, 'release ships exactly 155 executable CLI entrypoints' );
