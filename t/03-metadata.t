...
close $env;
like( $env_text, qr/^VERSION=0\.67$/m, '.env stores version 0.67' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '0.67', 'module version matches .env' );
...
is( scalar @commands, 91, 'release ships exactly 91 executable CLI entrypoints' );
