...
warning log, TKT-1102). `lib/Tira.pm` is 15,775 lines now (TKT-1118 added the enforcement-lock coverage for `_announce_upgrade`, `bridge_write`, `bridge_touch`, `_enforcement_record`, `rule_suspend`, `police_suspend`); it was 15,584 lines as of TKT-1133, and 15,368 lines as of TKT-972. TKT-1098 first
