...
.tasklist-card{padding:.9rem;border-radius:.6rem .6rem 1.4rem .6rem;color:#241d06;box-shadow:0 12px 26px rgba(0,0,0,.32),0 1px 0 rgba(255,255,255,.35) inset;transform:rotate(-1deg);font-size:.86rem;line-height:1.4;display:flex;flex-direction:column;gap:.5rem;transition:transform .15s ease}
