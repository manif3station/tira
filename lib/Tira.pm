...
.tasklist-card__chip{display:inline-flex;align-items:center;gap:.3rem;padding:.15rem .4rem;border-radius:.4rem;background:rgba(255,255,255,.4);font-size:.72rem;font-weight:700}.tasklist-card__chip-link{cursor:pointer;text-decoration:underline dotted}.tasklist-card__chip-link:hover{text-decoration-style:solid}
