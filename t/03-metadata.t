...
close $env;
like( $env_text, qr/^VERSION=0\.06$/m, '.env stores version 0.06' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '0.06', 'module version matches .env' );
...
is( scalar @commands, 75, 'release ships exactly 75 executable CLI entrypoints' );
