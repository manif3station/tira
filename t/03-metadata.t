...
close $env;
like( $env_text, qr/^VERSION=5\.41$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '5.41', 'and the release being made is the one intended' );
...
is( scalar @commands, 187, 'release ships exactly 187 executable CLI entrypoints' );
