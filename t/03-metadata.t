...
close $env;
like( $env_text, qr/^VERSION=3\.59$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '3.59', 'and the release being made is the one intended' );
...
is( scalar @commands, 157, 'release ships exactly 157 executable CLI entrypoints' );
