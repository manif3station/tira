...
close $env;
like( $env_text, qr/^VERSION=4\.36$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '4.36', 'and the release being made is the one intended' );
...
is( scalar @commands, 178, 'release ships exactly 178 executable CLI entrypoints' );
