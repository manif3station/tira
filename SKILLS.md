...
tira.column.update --type TYPE --name SLUG [--notify-after MINUTES] [--watch|--no-watch] [--terminal|--no-terminal] [--queue|--no-queue] [--required-action TEXT ...] [--entry-required-action TEXT ...] [--administrative-action TEXT ...] [--next SLUG ...] [-o FORMAT]
