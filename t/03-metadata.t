...
close $env;
like( $env_text, qr/^VERSION=2\.72$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '2.72', 'and the release being made is the one intended' );
...
is( scalar @commands, 150, 'release ships exactly 150 executable CLI entrypoints' );
