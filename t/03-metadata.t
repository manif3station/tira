...
close $env;
like( $env_text, qr/^VERSION=0\.56$/m, '.env stores version 0.56' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '0.56', 'module version matches .env' );
...
is( scalar @commands, 86, 'release ships exactly 86 executable CLI entrypoints' );
