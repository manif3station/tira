...
close $env;
like( $env_text, qr/^VERSION=0\.54$/m, '.env stores version 0.54' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '0.54', 'module version matches .env' );
...
is( scalar @commands, 85, 'release ships exactly 85 executable CLI entrypoints' );
