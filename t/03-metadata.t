...
close $env;
like( $env_text, qr/^VERSION=0\.75$/m, '.env stores version 0.75' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '0.75', 'module version matches .env' );
...
is( scalar @commands, 99, 'release ships exactly 99 executable CLI entrypoints' );
