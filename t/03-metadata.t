...
close $env;
like( $env_text, qr/^VERSION=5\.30$/m, '.env stores the version being released' );
...
is( $Tira::VERSION, '5.30', 'and the release being made is the one intended' );
...
is( scalar @commands, 184, 'release ships exactly 184 executable CLI entrypoints' );
