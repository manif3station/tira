...
close $env;
like( $env_text, qr/^VERSION=1\.23$/m, '.env stores version 1.23' );
...
use lib 'lib';
use Tira;
is( $Tira::VERSION, '1.23', 'module version matches .env' );
...
is( scalar @commands, 130, 'release ships exactly 130 executable CLI entrypoints' );
